...
class ResourcesDashboard(Dashboard):
    ...
    def click_resources_menu(self):
        self.wait_until_clickable((By.ID, "ifaws-aws-resources-link")).click()
...
def app_specific_action(webdriver, datasets):
    ...
    dashboard_page = ResourcesDashboard(webdriver)

    @print_timing("selenium_app_ui_connector_menu")
    def measure():
        dashboard_page.go_to()
        dashboard_page.click_resources_menu()  # Wait for connector menu trigger
